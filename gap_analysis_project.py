                ...
                if gap_line.to_project and gap_line.keep:
                    ...
                    for workload in gap_line.workloads:
                        if workload.duration > 0:
                            workload_vals = { 
                                'name' : gap_line.functionality.name[0:100] + " / " + workload.type.name[0:50],
                                'code_gap' : gap_line.code or "",
                                'project_id' : project_id,
                                'notes': "",
                                'partner_id':    partner_id,
                                ...
                                'org_planned_hours': workload.duration,
                                'planned_hours': workload.duration,
                                'remaining_hours': workload.duration,
                            }
                            task_pool.create(cr, uid, workload_vals, context=context)
